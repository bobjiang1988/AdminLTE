...
module.exports = function (grunt) { // jshint ignore:line
    ...
    less  : {
      ...
      skins        : {
        files: {
          ...
          'dist/css/skins/skin-purple-lighter.css': 'build/less/skins/skin-purple-lighter.less',
      ...
      minifiedSkins: {
        ...
        files  : {
          ...
          'dist/css/skins/skin-purple-lighter.min.css': 'build/less/skins/skin-purple-lighter.less',
  ...
  grunt.registerTask('build', ['clean:dist', 'image', 'js', 'css'])
